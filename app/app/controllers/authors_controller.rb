class AuthorsController < ApplicationController
  ...
  def destroy
    ...
    if author.paper_authors.exists?
      flash[:error] = "Cannot delete author with associated papers."
  ...
  private
    ...
    def author_params
      params.require(:author).permit(:name, :is_committee)
    end
end
