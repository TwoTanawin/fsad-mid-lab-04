class PapersController < ApplicationController
  ...
  def destroy
    ...
    if @paper.keywords.exists? || @paper.paper_authors.exists?
      flash[:error] = "Cannot delete paper with associated keywords or authors."
      redirect_to papers_path
    else
      @paper.destroy
      flash[:success] = "Paper successfully deleted."
      redirect_to papers_path
    end
  end
