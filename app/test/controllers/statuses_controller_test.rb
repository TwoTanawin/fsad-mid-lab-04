...
class StatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create status" do
    assert_difference("Status.count") do
      post statuses_url, params: { status: { is_rejected: @status.is_rejected, paper_id: @status.paper_id } }
    end
  ...
  test "should update status" do
    patch status_url(@status), params: { status: { is_rejected: @status.is_rejected, paper_id: @status.paper_id } }
