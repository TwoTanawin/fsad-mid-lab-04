...
class KeywordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create keyword" do
    assert_difference("Keyword.count") do
      post keywords_url, params: { keyword: { keyword: @keyword.keyword, paper_id: @keyword.paper_id } }
    end
  ...
  test "should update keyword" do
    patch keyword_url(@keyword), params: { keyword: { keyword: @keyword.keyword, paper_id: @keyword.paper_id } }
