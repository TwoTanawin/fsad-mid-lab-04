...
class PaperAuthorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paper_author" do
    assert_difference("PaperAuthor.count") do
      post paper_authors_url, params: { paper_author: { author_id: @paper_author.author_id, paper_id: @paper_author.paper_id } }
    end
  ...
  test "should update paper_author" do
    patch paper_author_url(@paper_author), params: { paper_author: { author_id: @paper_author.author_id, paper_id: @paper_author.paper_id } }
